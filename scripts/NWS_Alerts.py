...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        if req_type == 'summary':
            ...
            nws_alerts = nws.WeatherAlerts(state=req_location['state'])
